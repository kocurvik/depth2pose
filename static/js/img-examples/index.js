import { attachCardToggle, escapeHtml } from '../global.js';
...
function ensureExamplesPanel() {
	...
	attachCardToggle('benchmarkExamplesCard', 'examplesToggle', 'examplesContent', 'Show examples', 'Hide examples');
...
function renderPanelShell(titleText, subtitleText, bodyHtml, options = {}) {
	...
	if (els.subtitle) els.subtitle.textContent = subtitleText || '';
